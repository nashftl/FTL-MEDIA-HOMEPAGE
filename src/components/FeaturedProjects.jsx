  ...
  const projects = [
    {
      ...
      category: "Music",
      title: "Coverflow",
      description: "An interactive 3D album cover carousel featuring smooth animations and intuitive touch controls. Browse through albums with a visually stunning coverflow effect.",
      techTags: ["React", "CSS3", "JavaScript", "3D Transforms"],
    ...
    },
    {
      ...
      category: "Utility",
      title: "Flick Vault",
      description: "A comprehensive media management tool for tracking watched movies, TV shows, and videos. Features integrated search capabilities and organized viewing history.",
      techTags: ["React", "API Integration", "Node.js", "MongoDB"],
    ...
    },
    {
      ...
      category: "Web Design",
      title: "FTL Media",
      description: "A professional homepage for a PR, marketing, and web services firm. Features modern design, responsive layout, and clear service presentation.",
      techTags: ["React", "Tailwind CSS", "Vite", "Responsive Design"],
    ...
    },
    {
      ...
      category: "Music",
      title: "FTL Radio",
      description: "An immersive homepage for FTL Radio record label featuring 3D visuals, smooth animations, and dynamic content management for showcasing artists and releases.",
      techTags: ["React", "Three.js", "Framer Motion", "Contentful CMS"],
    ...
    },
    {
      ...
      category: "Utility",
      title: "Label Ops",
      description: "An operations dashboard for music labels to monitor releases, track artist activities, and manage administrative tasks with secure authentication and role-based access.",
      techTags: ["React", "Node.js", "Express", "PostgreSQL", "Auth"],
    ...
    },
    {
      ...
      description: "A vintage-styled portfolio template for music labels and artist collectives. Combines retro aesthetics with modern web functionality for a unique online presence.",
      techTags: ["HTML/CSS", "JavaScript", "Retro Design", "Responsive"],
    ...
    },
    {
      ...
      title: "Spaza Shop",
      description: "A full-featured e-commerce platform with product catalog, shopping cart, and secure checkout. Designed for small businesses establishing an online storefront.",
      techTags: ["React", "Tailwind CSS", "Context API", "E-commerce"],
    ...
    },
    {
      ...
      description: "A premium e-commerce experience for sunglasses featuring elegant product displays, filtering options, and smooth checkout flow for luxury retail.",
      techTags: ["React", "Tailwind CSS", "React Router", "Vite"],
    ...
    },
    {
      ...
      description: "A productivity tool for developers to plan projects, track tasks, and manage coding workflows. Features drag-and-drop boards and progress tracking.",
      techTags: ["React", "Tailwind CSS", "Drag & Drop", "Local Storage"],
