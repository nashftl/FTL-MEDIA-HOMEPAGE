1. beat spark - A creative platform designed to help music producers overcome beat block by generating inspiring beat ideas. This tool offers a variety of customizable options and templates. It's perfect for musicians looking to allowing users to spark their creativity effortlessly. Ideal for musicians seeking new inspiration and workflow enhancement.

- https://beat-spark.netlify.app/
- https://github.com/nashftl/groove-craft-limitless-v3.git

- status : needs ui/style update + backend

2. coverflow - An interactive 3D album cover wheel that showcases music albums and singles in a rotating coverflow interface. This application provides users with a cool way to browse and discover music collections, animation with responsive design.

- https://coverflow.netlify.app/
- https://github.com/nashftl/coverflow-3d.git

- status: needs speed update for initialisation

3. flick vault - A media management tool that allows users to store, organize, and update all their watched movies, TV shows, and videos in one centralized vault. With integrated search capabilities and backend support, it helps users keep track of their viewing history and discover new content efficiently.

- https://flick-vault.netlify.app/
- https://github.com/nashftl/flick-vault.git
...
- status: image updte + make less dark tonally